...
export default function AppLogo({ size = 'md', bg = 'sidebar' }: { size?: 'sm' | 'md' | 'lg', bg?: string } = {}) {
    const sizeClasses = {
    ...
    return (
        <div className={`flex items-center ${bgClass} text-sidebar-primary`}>
            <div className={`flex aspect-square ${sizeClasses[size].size} items-center justify-center text-primary`}>
